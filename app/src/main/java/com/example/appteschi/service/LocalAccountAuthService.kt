...
private val API_URL = ApiConfig.authCuenta
...
object LocalAccountAuthService : CuentaAuthService {
    data class Account(val matricula: String, val nombre: String)
        ...
        try {
            ...
            client.newCall(request).execute().use { response ->
                ...
                if (!response.isSuccessful || !json.optBoolean("ok")) {
                    ...
                    Result.success(Account(json.getString("matricula"), json.optString("nombre")))
                }
            }
