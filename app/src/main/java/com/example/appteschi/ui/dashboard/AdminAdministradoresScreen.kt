...
fun AdminAdministradoresScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        LazyColumn(
                ...
                item {
                    Card(colors = CardDefaults.cardColors(containerColor = Color.White), shape = RoundedCornerShape(16.dp), elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)) {
                        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            if (formError != null) Text(formError!!, color = ErrorRed, fontSize = 12.sp)
            ...
            if (error != null) item { Text(error!!, color = ErrorRed, fontSize = 12.sp) }
            if (cargando) {
                item {
        ...
        Column(modifier = Modifier.padding(14.dp)) {
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                ...
                Text(
                    ...
                    color = if (cuenta.activo) GreenPrimary else ErrorRed,
            ...
            if (!esUnoMismo) {
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(containerColor = if (cuenta.activo) ErrorRed else GreenPrimary)
